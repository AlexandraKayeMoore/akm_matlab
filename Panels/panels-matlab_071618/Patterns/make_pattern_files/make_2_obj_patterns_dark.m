%% make_2_obj_patterns_dark

% Make patterns with one bright, 8x8 pixel object at a fixed location,
...
pats2make(i).filename='Pattern_055_two_bright_objects_panel_1';

i=i+1;
pats2make(i).horizontalRange=1:8;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_056_two_bright_objects_panel_2';

i=i+1;
pats2make(i).horizontalRange=9:16;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_057_two_bright_objects_panel_3';

i=i+1;
pats2make(i).horizontalRange=9:16;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_057_two_bright_objects_panel_4';

i=i+1;
pats2make(i).horizontalRange=17:24;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_058_two_bright_objects_panel_5';

i=i+1;
pats2make(i).horizontalRange=17:24;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_059_two_bright_objects_panel_6';

i=i+1;
pats2make(i).horizontalRange=25:32;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_060_two_bright_objects_panel_7';

i=i+1;
pats2make(i).horizontalRange=25:32;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_061_two_bright_objects_panel_8';

i=i+1;
pats2make(i).horizontalRange=33:40;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_062_two_bright_objects_panel_9';

i=i+1;
pats2make(i).horizontalRange=33:40;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_063_two_bright_objects_panel_10';

i=i+1;
pats2make(i).horizontalRange=41:48;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_064_two_bright_objects_panel_11';

i=i+1;
pats2make(i).horizontalRange=41:48;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_065_two_bright_objects_panel_12';

i=i+1;
pats2make(i).horizontalRange=49:56;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_066_two_bright_objects_panel_13';
i=i+1;
pats2make(i).horizontalRange=49:56;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_067_two_bright_objects_panel_14';

i=i+1;
pats2make(i).horizontalRange=57:64;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_068_two_bright_objects_panel_15';

i=i+1;
pats2make(i).horizontalRange=57:64;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_069_two_bright_objects_panel_16';

i=i+1;
pats2make(i).horizontalRange=65:72;
pats2make(i).verticalRange=1:8;
pats2make(i).filename='Pattern_070_two_bright_objects_panel_17';

i=i+1;
pats2make(i).horizontalRange=65:72;
pats2make(i).verticalRange=9:16;
pats2make(i).filename='Pattern_071_two_bright_objects_panel_18';
...
for i=1:length(pats2make)
    ...
    if 0 % Check pattern
        ...
        myIm=squeeze(Pats(:,:,8,8));
        figure; imagesc(myIm)
        set(gca,'xtick',1:size(myIm,2),'ytick',1:size(myIm,1));
