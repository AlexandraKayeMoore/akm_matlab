%% Pattern 003: Bright obj. 2 LEDs wide at each location on the display

% "Dot location is encoded as combinations of x dim and y dim"
% ***State (56,16) (xpos,ypos) = whole screen dark***
...
str = [directory_name '\Pattern_003_Bright_Obj_2px'];
save(str, 'pattern');
