...
% xmax,ymax = whole screen dark
dark_X=LEDdotsAcross;  
dark_Y=LEDdotsVertically; 

% 1,1 = whole screen bright
bright_X=1;
bright_Y=1;


% This is a super simple function, so we can create the events structure
% as we go.
