%% Functions 001/002, elevationScan_2x2_30degPerSec_L2R_sequential 
...
fDescription='elevationScan_2x2_30degPerSec_L2R_sequential'
xfilename=['position_function_001_' fDescription '_Xpos.mat'];
yfilename=['position_function_002_' fDescription '_Ypos.mat'];

pseudo_shuffle_elevations=0; 
% 0: scan elevations sequentially, 1: scramble elevation positions (order is hard-coded below)

alternating_mvmt_direction=0; 
% 0: scan L-->R at all elevations, 1: interleve R-->L and L-->R scans
