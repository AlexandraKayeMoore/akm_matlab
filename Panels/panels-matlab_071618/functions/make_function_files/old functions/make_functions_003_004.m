%% Functions 003/004, elevationScan_2x2_30degPerSec_L2R_shuffled

clear all
clc


pseudo_shuffle_elevations=1; % 0: scan elevations sequentially, 1: scramble elevation positions (order is hard-coded below)

alternating_mvmt_direction=0; % 0: scan L-->R at all elevations, 1: interleve R-->L and L-->R scans
...
fDescription='elevationScan_2x2_30degPerSec_L2R_shuffled'
xfilename=['position_function_003_' fDescription '_Xpos.mat'];
yfilename=['position_function_004_' fDescription '_Ypos.mat'];
