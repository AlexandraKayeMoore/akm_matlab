%% Functions 007/008, elevationScan_2x2_15degPerSec_L2R_shuffled

clear all; clc

desiredSpeed_degreesPerSec=15; 
alternating_mvmt_direction=0;
pseudo_shuffle_elevations=1;  

fDescription='elevationScan_2x2_15degPerSec_L2R_shuffled'
xfilename=['position_function_007_' fDescription '_Xpos.mat']
yfilename=['position_function_008_' fDescription '_Ypos.mat']
