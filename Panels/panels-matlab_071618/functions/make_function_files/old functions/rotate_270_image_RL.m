%% Rotate image (vertical bar or star field) to the R or L
...
% fDescription='rotate_vertical_bar_36dps';
% xfuncNum='017';
% yfuncNum='018';
% desiredSpeed_degreesPerSec=36; 
% isiDuration_s=2;

fDescription='rotate_starfield_36dps';
xfuncNum='019';
yfuncNum='020';
desiredSpeed_degreesPerSec=36; 
isiDuration_s=4;
...
for reps=1:4
    ...
    events(i).xposvalues=1:71;
    events(i).yposvalues=repmat(yFixed,1,71);
    i=i+1;
end
